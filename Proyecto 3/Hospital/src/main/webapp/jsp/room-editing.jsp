<%-- 
    Document   : room-editing
    Created on : Nov 19, 2019, 4:13:00 PM
    Author     : zofia
--%>
...
<html>
    ...
    <body background="../img/background.jpg">
        ...
        <div class="card mb-3 log-in">           
            <div class="card-body"> 
                <h4 class="mb-3 text-center">Edit Room</h4>
                <form class="needs-validation" action="RoomController?action=7&id=${sessionScope.id}" method="POST" novalidate>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="price" placeholder="Maintenance Price" name="price" value="${requestScope.price}" required="">
