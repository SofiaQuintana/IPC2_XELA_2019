<%-- 
    Document   : specialist-registration
    Created on : Nov 19, 2019, 12:46:20 AM
    Author     : zofia
--%>
...
<html>
    ...
    <body background="../img/background.jpg">
        ...
        <div class="card mb-3 log-in">           
            <div class="card-body"> 
                <h4 class="mb-3 text-center">Register Specialist</h4>
                <form class="needs-validation" action="SpecialistController?action=3" method="POST" novalidate>
                    <div class="mb-3">
