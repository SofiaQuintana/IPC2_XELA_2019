<%-- 
    Document   : consultation-registration
    Created on : Nov 20, 2019, 10:48:39 PM
    Author     : zofia
--%>
...
<html>
    <head>
        ...
        <title>Medic Consultation</title>
    </head>
    <body background="img/background.jpg">
        ...
        <div class="card mb-3 log-in">           
            <div class="card-body"> 
                <h4 class="mb-3 text-center">Medic Consultation</h4>
                <form class="needs-validation" action="PatientController?action=7&patientCui=${patient.cui}" method="POST" novalidate="">
                    <div class="mb-3">
