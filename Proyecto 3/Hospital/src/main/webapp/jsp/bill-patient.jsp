<%-- 
    Document   : bill-patient
    Created on : Nov 21, 2019, 7:52:31 AM
    Author     : zofia
--%>
    ...
    <body background="img/background.jpg">
        ...
        <div class="card mb-3 log-in">           
            <div class="card-body"> 
                ...
                <form class="needs-validation" action="PatientController?action=16&patientCui=${bill.cui}" method="POST" novalidate="">
                    <div class="mb-3">
                        <label for="patientCui">Patient CUI</label>
                        <input type="text" class="form-control" id="patientCui" value="${bill.cui}" name="patientCui" disabled="">                    
                    </div>
                    <div class="mb-3">
